...
public class JPiece extends GenericPiece
{
   ...
   */
  public static final char CHARACTER = 'J';
  
  /**
   * Creates a J piece and the given initial point. The 0,0 is
  ...
  {
    super(new char[][]{new char[] {Piece.BG_CHARACTER, CHARACTER},
                       new char[] {Piece.BG_CHARACTER, CHARACTER},
