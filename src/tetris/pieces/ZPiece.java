...
public class ZPiece extends GenericPiece
{
   ...
   */
  public static final char CHARACTER = 'Z';
  
  /**
   * Creates a Z piece and the given initial point. The 0,0 is
  ...
  {
    super(new char[][]{new char[] {CHARACTER, CHARACTER, Piece.BG_CHARACTER},
                       new char[] {Piece.BG_CHARACTER, CHARACTER, CHARACTER}},
