 ...
 * @version Nov 11, 2010
 */
public class IPiece extends GenericPiece
{
  /**
   * The character that represents this piece. 
   */
  public static final char CHARACTER = 'I';
  
  /**
   * Creates an I piece and the given initial point. The 0,0 is
  ...
  {
    super(new char[][]{new char[] {CHARACTER, CHARACTER, CHARACTER, CHARACTER}}, 
