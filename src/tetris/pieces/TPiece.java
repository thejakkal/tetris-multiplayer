...
public class TPiece extends GenericPiece
{
   ...
   */
  public static final char CHARACTER = 'T';
  
  /**
   * Creates a T piece and the given initial point. The 0,0 is
  ...
  {
    super(new char[][]{new char[] {Piece.BG_CHARACTER, CHARACTER, Piece.BG_CHARACTER},
                       new char[] {CHARACTER, CHARACTER, CHARACTER}},
